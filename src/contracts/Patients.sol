...
contract Patients {
    ...
    ****/
    function addPatientName(string memory _patientId, string memory _name)
        public
    {
    ...
    ****/
    function getPatientName(string memory _patientId)
        public
        view
    ...
    /****
    This function adds the patients Blood Group 
    params _name -  patient blood group
    params _patientId - patient'a generated Id.
    ****/
    function addPatientBloodGroup(
        string memory _patientId,
        string memory _bloodGroup
    ) public {
        patientIdInformation[_patientId].patientBloodGroup = _bloodGroup;
    }

    /****
    This function returns the patients blood group
    params _patientId -  patient name
    ****/
    function getPatientBloodGroup(string memory _patientId)
        public
        view
        returns (string memory)
    {
        return patientIdInformation[_patientId].patientBloodGroup;
    }
    ...
    params _patientId
    ****/
    function addPatientMobileNumber(
        string memory _patientId,
        string memory _patientMobileNumber
    ) public {
        patientIdInformation[_patientId]
            .patientMobileNumber = _patientMobileNumber;
    }
    ...
    params _patientId
    ****/
    function getPatientMobileNumber(string memory _patientId)
        public
        view
        returns (string memory)
    {
    ...
    ****/
    ...
    params _patientId
    ****/
    function getPatientGender(string memory _patientId)
        public
        view
        returns (string memory)
    {
    ...
    ****/
    ...
    params _patientId
    ****/
    function getPatientAddress(string memory _patientId)
        public
        view
        returns (string memory)
    {
    ...
    ****/
    ...
    params _patientId
    ****/
    function getPatientDateOfBirth(string memory _patientId)
        public
        view
        returns (string memory)
    {
    ...
    /****
    This function adds the patients insurance
    params _patientMobileNumber -  patient patient insurance
    params _patientId
    ****/
    function addPatientInsurance(
        ...
        patientIdInformation[_patientId].patientInsurance = _patientInsurance;
    }

    /****
    This function returns the patients insurance
    params _patientId
    ****/
    function getPatientInsurance(string memory _patientId)
        public
        view
        returns (string memory)
    {
        return patientIdInformation[_patientId].patientInsurance;
    }
    ...
    ****/
    ...
    function addPatientAllergies(
        ...
        patientIdInformation[_patientId].allergiesKnown = string(
            abi.encodePacked(
                patientIdInformation[_patientId].patientMobileNumber,
                ", ",
                _allergy
            )
        );
    ...
    params _patientId
    ****/
    function getPatientAllergies(string memory _patientId)
        public
        view
        returns (string memory)
    {
